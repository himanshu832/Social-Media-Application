...
export default function Singlepost(props) {
 ...
 const commentt=useRef();
    ...
    //sending comments
    const sendComment=()=>{
         secaxios.post("http://localhost:5000/api/comments/addcomment",{
             ...
             let currdat=new Date()
                 ...
                 const newadd={
                     ...
                     text:commentt.current.value,
                     date:currdat.getFullYear()+"-"+ currmonth +"-"+currdat.getDate()  ,
    ...
    const recieveComments=async()=>{
         axios.get(`http://localhost:5000/api/comments/getcomments?id=${props.id}`).then((res)=>{
    ...
    const deletecomment=async(deleteme)=>{
        try{
         await secaxios.delete(`http://localhost:5000/api/comments/deletecomment`,{data:{
             postid:deleteme,
             username:props.curruser,
         }});
    ...
    return (
        ...
        <div className="postflex" style={{backgroundColor:'transparent'}}>
            ...
            <div className="description">
                <p style={{margin:"0px",paddingTop:"10px"}} >{props.description}</p>
            ...
            <div className="textareaflex">
                ...
                <textarea style={{padding:"5px",width:"90%",minWidth:"200px",marginRight:"20%"}}placeholder="What's on your mind" rows="2" ref={commentt}></textarea> 
            </div>
            
            <Button className="bg-dark text-white py-1 px-3 mt-3 mb-3" onClick={sendComment}>Comment</Button>
        
        {allcomments.length!==0 && allcomments.reverse().map((element,ind)=>{
            console.log(element)
            return (
                <div className="postmargin"> <Comment 
